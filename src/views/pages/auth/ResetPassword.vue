        ...
        <form @submit.stop.prevent="handleSubmit">
          ...
          <div class="form-group">
            ...
            <input
              ...
              placeholder="Token"
              class="form-control"
              :class="{ 'is-invalid': $v.user.token.$error }"
            />
            <span v-if="!$v.user.token.required" class="invalid-feedback">
              token is required</span
            >
            <div class="text-danger .fs-2" v-if="errors && errors.errors">
              <small>{{ errors.errors.token[0] }}</small>
            </div>
          </div>
          <div class="form-group">
            <input
  ...
  export default {
    ...
    methods: {
      handleSubmit() {
        ...
        axios
          .post(
            "https://mmt-web.herokuapp.com/api/reset_password",
            formData,
            {}
          )
          .then((res) => {
