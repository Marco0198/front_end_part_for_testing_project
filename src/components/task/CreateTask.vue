<template>
  <div>
    <b-button class="btn btn-warning mb-5" v-b-modal.modal-prevent-closing>Create Task</b-button>
    <b-modal
    ...
    >
      ...
      <b-icon @click="$bvModal.hide('modal-prevent-closing')" icon="x-circle"  variant="danger" aria-hidden="true"></b-icon>
